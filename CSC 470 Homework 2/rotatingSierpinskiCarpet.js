...
function init(){
    ...
    // Have the rotate button and subdivision slider functional at the start of the program
    // (This is just in case the button is pressed or the slider is 
    // used when init() has to initialize data).

    // Note: We will only need to call init() at the start of the program and when 
    // the number of subdivisions is changed. These restrictions are enforced to
    // significantly reduce the risk of a memory leak.
